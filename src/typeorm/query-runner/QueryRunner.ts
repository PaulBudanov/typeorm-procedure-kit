...
export interface QueryRunner {
   ...
   */
  getSchemas(database?: string): Promise<Array<string>>;
   ...
   */
  getTables(tablePaths?: Array<string>): Promise<Array<Table>>;
   ...
   */
  getViews(viewPaths?: Array<string>): Promise<Array<View>>;
   ...
   * Adds new columns.
   */
  addColumns(table: Table | string, columns: Array<TableColumn>): Promise<void>;
