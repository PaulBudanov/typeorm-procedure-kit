...
export interface Driver {
   ...
   */
  supportedUpsertTypes: Array<UpsertType>;
   ...
   */
  supportedOnUpdateTypes?: Array<OnUpdateType>;
   ...
   */
  withScaleColumnTypes: Array<ColumnType>;
   ...
   */
  escape(name: string, isNeedQuote?: boolean): string;
   ...
   */
  preparePersistentValue(value: unknown, column: ColumnMetadata): unknown;

  /**
   * Prepares given value to a value to be persisted, based on its column type.
   */
  prepareHydratedValue(value: unknown, column: ColumnMetadata): unknown;
