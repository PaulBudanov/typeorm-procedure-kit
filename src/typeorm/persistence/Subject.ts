...
import type { SubjectChangeMap } from './SubjectChangeMap.js';
...
export class Subject {
  public readonly '@instanceof' = Symbol.for('Subject');
   ...
   */
  public generatedMap?: ObjectLiteral;

  /**
   * Inserted values with updated values of special and default columns.
   * Has entity-like structure (not just column database name and values).
   */
  public insertedValueSet?: ObjectLiteral;
   ...
   */
  public canBeUpdated = false;

  /**
   * Indicates if this subject MUST be removed from the database.
   * This means that this subject either was removed, either was removed by cascades.
   */
  public mustBeRemoved = false;
   ...
   */
  public canBeRecovered = false;

  /**
   * Relations updated by the change maps.
   */
  public updatedRelationMaps: Array<{
   ...
   */
  public diffColumns: Array<ColumnMetadata> = [];

  /**
   * List of updated relations
   */
  public diffRelations: Array<RelationMetadata> = [];
  ...
  public constructor(options: {
    ...
    changeMaps?: Array<SubjectChangeMap>;
  }) {
   ...
   */
  public get mustBeInserted(): boolean {
   ...
   */
  public get mustBeUpdated(): boolean | undefined {
    return (
      this.canBeUpdated &&
      this.identifier &&
   ...
   * and if it does have differentiated columns or relations.
   */
  public get mustBeSoftRemoved(): boolean | ObjectLiteral | undefined {
    return (
   ...
   * and if it does have differentiated columns or relations.
   */
  public get mustBeRecovered(): boolean | ObjectLiteral | undefined {
    return (
      this.canBeRecovered &&
      this.identifier &&
      (this.databaseEntityLoaded === false ||
   ...
   */
  public createValueSetAndPopChangeMap(): ObjectLiteral {
    const changeMapsWithoutValues: Array<SubjectChangeMap> = [];
    const changeSet = this.changeMaps.reduce((updateMap, changeMap) => {
      let value: ObjectLiteral | Subject | undefined =
        changeMap.value as Subject;
      ...
      if (this.metadata.isJunction && changeMap.column) {
        valueMap = changeMap.column.createValueMap(
          changeMap.column.referencedColumn!.getEntityValue(
        ...
        if (ObjectUtils.isObject(value) && !Buffer.isBuffer(value)) {
          ...
          valueMap = changeMap.relation!.createValueMap(value as ObjectLiteral);
          this.updatedRelationMaps.push({
            relation: changeMap.relation,
            value: value as ObjectLiteral,
          });
        }
      }
