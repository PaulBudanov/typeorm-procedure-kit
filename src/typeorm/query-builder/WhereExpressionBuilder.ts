...
export interface WhereExpressionBuilder {
   ...
   * Additionally you can add parameters used in where expression.
   */
  where(where: Array<ObjectLiteral>, parameters?: ObjectLiteral): this;
   ...
   * Additionally you can add parameters used in where expression.
   */
  andWhere(where: Array<ObjectLiteral>, parameters?: ObjectLiteral): this;
   ...
   * Additionally you can add parameters used in where expression.
   */
  orWhere(where: Array<ObjectLiteral>, parameters?: ObjectLiteral): this;
