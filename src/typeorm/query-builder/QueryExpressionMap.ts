...
export class QueryExpressionMap {
   ...
   */
  valuesSet?: ObjectLiteral | Array<ObjectLiteral>;
   ...
   */
  extraReturningColumns: Array<ColumnMetadata> = [];
   ...
   * JOIN queries.
   */
  joinAttributes: Array<JoinAttribute> = [];

  /**
   * RelationId queries.
   */
  relationIdAttributes: Array<RelationIdAttribute> = [];

  /**
   * Relation count queries.
   */
  relationCountAttributes: Array<RelationCountAttribute> = [];
   ...
   * HAVING queries.
   */
  havings: Array<{ type: 'simple' | 'and' | 'or'; condition: string }> = [];
   ...
   */
  options: Array<SelectQueryBuilderOption> = [];
   ...
   */
  whereEntities: Array<ObjectLiteral> = [];
   ...
   */
  locallyGenerated: Record<number, ObjectLiteral> = {};
  ...
  constructor(protected connection: DataSource) {
    ...
    this.timeTravel =
      (connection.options as CockroachConnectionOptions)?.timeTravelQueries ||
      false;
  }
