...
export interface IBaseConfig {
  ...
  poolSize: number;
  /**
   * Controls quoting of physical identifiers generated by the bundled TypeORM
   * query builders. Aliases remain quoted. Defaults to `disabled`.
   */
  ...
  /**
   * Resource limits for materialized procedure and notification data. Missing
   * values use the library's secure defaults.
   */
